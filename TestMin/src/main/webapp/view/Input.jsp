...
<form action="../Control" method="post" id="signupForm">
<fieldset>
...
<div class="form-group row">
<label for="age" class="ml-sm-2 col-form-label">나이</label>
<div class="ml-sm-2">
<input type="text" name="age" id="age" class="form-control form-control-sm">
</div>
</div>
<div class="form-group row">
<label for="birth" class="ml-sm-2 col-form-label">생년월일</label>
<div class="ml-sm-2">
<input type="date" name="birth" id="birth" class="form-control form-control-sm">
</div>
</div>
